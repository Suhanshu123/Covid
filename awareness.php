  ...
  <body>
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="travelAlerts.html">Travel Alert</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="gatheringAlerts.html">Gathering Alert</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="bestPractices.html">Best Practices</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="papers.html">Recent Papers</a>
        </li>
      </ul>
    ...
    $sql = "SELECT Date, Heading, Link FROM Awareness";
